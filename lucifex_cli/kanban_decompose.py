...
Invoked by ``lucifex kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Lucifex Agent board.
...
def _profile_author() -> str:
    """Mirror of ``lucifex_cli.kanban._profile_author``."""
    return (
