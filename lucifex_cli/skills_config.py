"""
Skills configuration for Lucifex Agent.
`lucifex skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.lucifex/config.yaml under:
...
from lucifex_cli.config import cfg_get, load_config, save_config
from lucifex_cli.colors import Colors, color
from lucifex_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `lucifex skills`."""
    from lucifex_cli.curses_ui import curses_checklist
