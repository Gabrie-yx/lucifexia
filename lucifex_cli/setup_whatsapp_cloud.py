...
Entry point: ``lucifex whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``lucifex_cli/main.py``).
...
Lucifex gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Lucifex to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Lucifex needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Lucifex gateway in another terminal:")
    print("         lucifex gateway")
    print()
    ...
    print()
    print("  Docs: https://lucifex-agent.nousresearch.com/docs/user-guide/")
