...
from lucifex_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
...
class PluginContext:
    ...
    def register_dashboard_auth_provider(self, provider) -> None:
        ...
        ``provider`` must be an instance of
        :class:`lucifex_cli.dashboard_auth.DashboardAuthProvider`. Used by
    ...
    def register_secret_source(self, source) -> None:
        ...
        ``~/.lucifex/.env`` loads, before Lucifex reads credentials — when
        ...
        spawned Lucifex process (gateway children, cron sessions,
    ...
    def register_auxiliary_task(
        ...
        *,
        ...
        # Lazy import to avoid circular: lucifex_cli.main imports plugins indirectly
        from lucifex_cli.main import _AUX_TASKS as _BUILTIN_AUX_TASKS
...
class PluginManager:
    ...
    def _discover_and_load_inner(self) -> None:
        ...
        #
        # Repo-shipped plugins live next to lucifex_cli/. Two layouts are
