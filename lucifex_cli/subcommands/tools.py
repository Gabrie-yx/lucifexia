"""``lucifex tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'lucifex tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # lucifex tools list [--platform cli]
    ...
    # lucifex tools disable <name...> [--platform cli]
    ...
    # lucifex tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `lucifex tools` runs after you pick a provider that\n"
