...
class CLICommandsMixin:
    ...
    def _handle_snapshot_command(self, command: str):
        ...
        """
        from lucifex_cli.backup import (
        ...
        if subcmd in {"list", "ls"}:
            ...
            if not snaps:
                ...
                return
            print(f"  State snapshots ({display_lucifex_home()}/state-snapshots/):\n")
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from lucifex_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from lucifex_cli.clipboard import has_clipboard_image
    ...
    def _handle_tools_command(self, cmd: str):
        ...
        def _run_capture(ns: Namespace) -> None:
            ...
            # Buffer reports isatty()=True so color() in lucifex_cli/colors.py
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from lucifex_cli.main import _resolve_session_by_name_or_id
        ...
        # same directory as a startup `lucifex -c`/`--resume`. The startup resume
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from lucifex_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from lucifex_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        """Handle /skills slash command — delegates to lucifex_cli.skills_hub."""
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from lucifex_cli.skills_hub import handle_skills_slash
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from lucifex_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
        ...
        if len(parts) < 2 or not parts[1].strip():
            ...
            print("\n  Usage: /skin <name>")
            print(f"  Custom skins: drop a YAML file in {display_lucifex_home()}/skins/\n")
            return
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from lucifex_cli.models import _is_anthropic_fast_model
    ...
    def _handle_update_command(self) -> bool:
        ...
        if is_managed():
            print(f"  ✗ {format_managed_message('update Lucifex Agent')}")
            return False
        ...
        choices = [
            ("once", "Update Now", "exit the current session and update Lucifex Agent"),
