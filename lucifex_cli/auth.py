...
def is_provider_explicitly_configured(provider_id: str) -> bool:
    ...
    # the user initiated inside Lucifex (manual add / device-code / PKCE), plus
    ...
    try:
        for entry in read_credential_pool(normalized):
            ...
            if source.startswith("env:"):
                ...
                continue
            if (
                source in {"device_code", "loopback_pkce", "lucifex_pkce", "manual"}
...
def _quarantine_nous_oauth_state(
    ...
    *,
    ...
    # sizes/booleans. NEVER pass a raw token/agent_key into the log call — Lucifex
