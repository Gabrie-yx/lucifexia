...
Three cookies in play:
  ...
  - lucifex_session_rt:   the OAuth refresh token
                         ...
                         Lucifex portal issues a rotating refresh token for the
...
SESSION_PROVIDER_COOKIE = "lucifex_session_provider"
...
def set_session_cookies(
    ...
    *,
    ...
    ``refresh_token`` is written as the RT cookie when non-empty. Lucifex portal
