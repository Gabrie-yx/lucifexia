...
def _redirect_uri(request: Request) -> str:
    ...
    from lucifex_cli.dashboard_auth.prefix import (
        prefix_from_request,
        resolve_public_url,
    )
...
def _prefix(request: Request) -> str:
    ...
    ``lucifex_cli.dashboard_auth.prefix`` for the normalisation rules.
    """
...
async def api_auth_ws_ticket(request: Request):
    ...
    from lucifex_cli.dashboard_auth.ws_tickets import TTL_SECONDS, mint_ticket
