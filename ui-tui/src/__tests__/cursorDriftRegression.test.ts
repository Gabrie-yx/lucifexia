 ...
 *
 * Symptom: in `lucifexex --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@lucifex/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using lucifexex --tui and as i type multiline my caret at the end will often ' +
