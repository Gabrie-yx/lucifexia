import { Box, type ScrollBoxHandle, stringWidth, Text } from '@lucifex/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (lucifexex_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (lucifexex_DEV_CREDITS), lowest priority,
