...
await build({
  ...
  // Skip the prebuilt @lucifex/ink bundle and inline the source instead:
  ...
  alias: {
    '@lucifex/ink': resolve(root, 'packages/lucifex-ink/src/entry-exports.ts'),
    '@lucifex/shared': resolve(root, '../apps/shared/src/index.ts')
  },
...
// the `node` token, leaving a broken interpreter). The lucifex_cli launcher
