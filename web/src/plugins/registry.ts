 ...
 *
 * Plugins call window.__LUCIFEX_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__LUCIFEX_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__LUCIFEX_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__LUCIFEX_PLUGIN_SDK__ = {
    ...
    // window.__LUCIFEX_SESSION_TOKEN__ directly.
    authedFetch,
