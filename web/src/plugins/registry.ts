 ...
 *
 * Plugins call window.__lucifexex_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__lucifexex_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__lucifexex_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__lucifexex_PLUGIN_SDK__ = {
    ...
    // window.__lucifexex_SESSION_TOKEN__ directly.
    authedFetch,
