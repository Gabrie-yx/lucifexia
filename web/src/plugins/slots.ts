 ...
 * `window.__lucifexex_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the lucifexex brand in the top bar
 ...
 *  `window.__lucifexex_PLUGINS__.registerSlot(...)`.
 *
