 ...
 * `window.__LUCIFEX_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Lucifex brand in the top bar
 ...
 *  `window.__LUCIFEX_PLUGINS__.registerSlot(...)`.
 *
