 ...
 *
 * Values mirror lucifex_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the lucifexex default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (lucifexex' default when unset). */
