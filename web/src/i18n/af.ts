...
export const af: Translations = {
  ...
  status: {
    ...
    stopped: "Gestop",
    updateLucifex: "Werk Lucifex op",
    updatingLucifex: "Besig om Lucifex op te werk…",
  ...
  pluginsPage: {
    ...
    headline:
      "Ontdek, installeer, aktiveer en werk Lucifex-inproppe op (`lucifex plugins` ekwivalent).",
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.lucifex/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.lucifex/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.lucifex/skills/",
