...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateLucifex: "Lucifex'i Güncelle",
    updatingLucifex: "Lucifex güncelleniyor…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bu eklenti ~/.lucifex/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.lucifex/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.lucifex/skills/ adresinden yüklenir",
