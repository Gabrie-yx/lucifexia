...
# DeepInfra STT base URL now resolved via lucifex_cli.models.deepinfra_base_url (shared).
...
def _transcribe_deepinfra(file_path: str, model_name: str) -> Dict[str, Any]:
    ...
    ``lucifex_cli.models`` helpers so every DeepInfra surface resolves the
