...
_PATTERNS: List[Tuple[str, str, str]] = [
    ...
    (r'unset\s+\w*(?:CLAUDE|CODEX|lucifexex|AGENT|OPENAI|ANTHROPIC)\w*', "env_var_unset_agent", "context"),
    ...
    (r'\$HOME/\.lucifexex/\.env|\~/lucifexifex/\.envlucifexucifex_env", "strict"),
    ...
    (r'(update|modify|edit|write|change|append|add\s+to)\s+[^\n]{0,2048}\.lucifexex/(config\.yaml|SOUL\.md)',lucifexifex_config_mod", "strict"),
