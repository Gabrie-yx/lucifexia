...
def _image_uses_init_entrypoint(docker_exe: str, image: str) -> bool:
    ...
    ``lucifex-agent:latest``) already provide their own PID-1 init and execute
...
class DockerEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        # (TERMINAL_SANDBOX_DIR, default ~/.lucifex/sandboxes/). Non-persistent
        ...
        # s6-overlay images (e.g. lucifex-agent:latest) already use /init as PID 1
    ...
    def _build_init_env_args(self) -> list[str]:
        ...
        lucifex_env = _load_lucifex_env_vars() if forward_keys else {}
