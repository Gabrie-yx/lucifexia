...
def auth_json_path():
    """Return the lucifexex auth store path, respecting LUCIFEX_HOME overrides."""
    return get_lucifex_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`lucifexex tools`, banner/status paint, provider
