...
Only included in the lucifex-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "lucifex-agent (https://github.com/NousResearch/lucifex-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_lucifex_home() / "cache" / "discord_capabilities.json"
