---
sidebar_position: 8
title: "Use Voice Mode with lucifexex"
description: "A practical guide to setting up and using lucifexex voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with lucifexex
...
- you want lucifexex sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in lucifexex.
...
## Step 1: make sure normal lucifexex works first
...
lucifexex supports both local and cloud speech stacks.
...
4. lucifexex transcribes and responds
...
- asking lucifexex to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full lucifexex loop.

## Tuning CLI behavior

### Silence threshold

If lucifexex starts/stops too aggressively, tune:
...
lucifexex stays a normal chat bot, but can speak replies.
...
- you want lucifexex to function like a portable research or ops assistant
...
lucifexex joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- lucifexex detects speech boundaries
- transcripts are posted in the associated text channel
- lucifexex responds in text and audio
