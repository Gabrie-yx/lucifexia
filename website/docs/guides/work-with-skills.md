...
For how to ship skills in your own plugin, see [Build a Lucifex Plugin → Bundle skills](/developer-guide/plugins#bundle-skills).
...
lucifex config get skills.config --json
```
