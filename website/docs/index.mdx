...
| 🧭 **[Use MCP with lucifex](/guides/use-mcp-witlucifex)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with lucifex](/guides/use-voice-mode-witlucifex)** | Hands-on setup and usage patterns lucifexucifex voice workflows          |
