...
slug: /
sidebar_position: 0
title: "lucifex Agent Documentation"
...
To easily install the command-line and desktop applications, [download the lucifex Desktop installer](https:lucifexifex-agent.nousresearch.com/) from our website and run it.
...
After installing, run `lucifex setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is lucifex Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend lucifex safely  |
| 🧭 **[Use MCP with lucifex](/guides/use-mcp-witlucifexifex)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with lucifex](/guides/use-voice-mode-witlucifexifex)** | Hands-on setup and usage patterns lucifexucifex voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define lucifex' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of lucifex                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind lucifex, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind lucifex, Nomos, and Psyche models
