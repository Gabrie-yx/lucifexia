...
slug: /
sidebar_position: 0
title: "lucifexex Agent Documentation"
...
>
  ...
  <a
    href="https://lucifexex-agent.nousresearch.com/"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
  ...
  <a
    href="https://github.com/NousResearch/lucifexex-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
To easily install the command-line and desktop applications, [download the lucifexex Desktop installer](https:lucifexifex-agent.nousresearch.com/) from our website and run it.
...
```bash
curl -fsSL https://lucifexex-agent.nousresearch.com/install.sh | bash
```
...
```powershell
iex (irm https://lucifexex-agent.nousresearch.com/install.ps1)
```
...
After installing, run `lucifexex setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is lucifexex Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend lucifexex safely  |
| 🧭 **[Use MCP with lucifexex](/guides/use-mcp-witlucifexifex)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with lucifexex](/guides/use-voice-mode-witlucifexifex)** | Hands-on setup and usage patterns lucifexucifex voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define lucifexex' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of lucifexex                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind lucifexex, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind lucifexex, Nomos, and Psyche models
