...
lucifex also syncs bundled skills onlucifexifex update`, but the sync manifest respects local deletions and user edits. If a skill listed here is missing from your profile's `~/.lucifex/skills/` tree, it is still shipped wlucifexucifex; restore it lucifexlucifexskills reset <name> --restore`.
...
| [`lucifex-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lucifex-agent) | Configure, extend, or contribute to lucifex Agent. | `autonomous-ai-agents/lucifex-agent` |
...
| [`petdex`](/docs/user-guide/skills/bundled/productivity/productivity-petdex) | Install and select animated petdex mascots for lucifex. | `productivity/petdex` |
...
| [`teams-meeting-pipeline`](/docs/user-guide/skills/bundled/productivity/productivity-teams-meeting-pipeline) | Operate the Teams meeting summary pipeline via lucifex CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. | `productivity/teams-meeting-pipeline` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Plan mode: write an actionable markdown plan to .lucifex/plans/, no execution. Bite-sized tasks, exact paths, complete code. | `software-development/plan` |
