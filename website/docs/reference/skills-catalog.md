...
| [`lucifex-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lucifex-agent) | Configure, extend, or contribute to Hermes Agent. | `autonomous-ai-agents/lucifex-agent` |
