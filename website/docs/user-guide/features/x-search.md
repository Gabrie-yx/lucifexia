...
:::tip
If you're paying Portal for an xAI model anyway, Live Search calls bill against the same xAI key configured for chat. See [Lucifex portal](/integrations/lucifex-portal).
:::
