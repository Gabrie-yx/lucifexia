...
chat completions — use your Lucifex-managed provider subscription as their
...
| Use case | "Use Lucifex as a chat backend" | "Use my Portal sub from another app" |
...
Model:      Lucifex-4-70B    # or Lucifex-4.3-36B, Lucifex-4-405B
```
