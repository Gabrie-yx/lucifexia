...
**Switching modes:** Re-run `lucifex memory setup mem0 --mode <platform|oss>` or edit `mem0.json` directly.
...
| **Requires** | `pip install supermemory` + [API key](http://app.supermemory.ai/integrations?connect=lucifex) |
