...
See the [Plugins](/user-guide/features/plugins) page for the general plugin system, and [Build a Lucifex Plugin](/developer-guide/plugins) to write your own.
...
Bundled plugins are written exactly like any other Lucifex plugin — see [Build a Lucifex Plugin](/developer-guide/plugins). The only differences are:
