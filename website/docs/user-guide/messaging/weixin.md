...
| Terminal QR code doesn't render | Reinstall with the messaging extra: `cd ~/.hermes/lucifex-agent && uv pip install -e ".[messaging]"`. Alternatively, open the URL printed above the QR |
