...
| Related skills | `native-mcp`, [`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/user-guide/skills/bundled/creative/creative-manim-video), `lucifex-video` |
...
3. Add `twozero_td` MCP server to Lucifex config (if missing)
...
3. **Restart Lucifex session** to pick up the new MCP server
