...
```bash
python3 -m pyfiglet "lucifexex" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=lucifexex&font=Slant" | boxes -d stone
```
