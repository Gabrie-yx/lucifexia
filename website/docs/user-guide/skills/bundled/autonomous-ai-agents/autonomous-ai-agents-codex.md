...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`lucifex-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-lucifex-agent) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the lucifexex terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For lucifexex itself, `model.provider: openai-codex` uselucifexifex-managed Codex
OAuth from `~/.lucifex/auth.json` after `lucifexex auth add openai-codex`. For the
...
## lucifexex Gateway Caveat

When invoking the Codex CLI from a lucifexex gateway/service context (for example,
