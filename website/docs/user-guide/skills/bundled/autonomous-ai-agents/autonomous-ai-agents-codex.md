...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Lucifex terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Lucifex itself, `model.provider: openai-codex` uses Lucifex-managed Codex
...
## Lucifex Gateway Caveat

When invoking the Codex CLI from a Lucifex gateway/service context (for example,
