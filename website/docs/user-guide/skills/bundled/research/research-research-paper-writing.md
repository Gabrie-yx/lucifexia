...
This skill is designed for the Lucifex agent. It uses Lucifex tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Lucifex skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.lucifex/plans/` | `skill_view("plan")` |
