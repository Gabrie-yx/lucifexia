...
Set your Tenor API key in your environment (add to `${LUCIFEX_HOME:-~/.lucifexex}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/lucifex-agent/blob/main/skills/media/gif-search/url)`
