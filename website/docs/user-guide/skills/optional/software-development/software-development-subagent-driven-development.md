...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | lucifexex Agent (adapted from obra/superpowers) |
| License | MIT |
