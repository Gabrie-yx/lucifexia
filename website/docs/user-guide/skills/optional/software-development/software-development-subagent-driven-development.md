...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Lucifex Agent (adapted from obra/superpowers) |
| License | MIT |
