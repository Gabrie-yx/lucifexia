...
- User wants **lucifexex itself to drive a browser** → uslucifexifex' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
