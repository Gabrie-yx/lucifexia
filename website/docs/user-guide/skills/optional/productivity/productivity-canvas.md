...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Lucifex Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${LUCIFEX_HOME:-~/.lucifex}/.env`:
