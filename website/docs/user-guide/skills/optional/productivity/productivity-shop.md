...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/productivity/shop` |
| Path | `optional-skills/productivity/shop` |
| Version | `1.0.1` |
| Author | Joe Rinaldi Johnson (joerj123), Lucifex Agent |
| License | MIT |
...
| Telegram (Lucifex Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |
