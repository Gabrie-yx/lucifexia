...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), lucifexex Agent |
| License | MIT |
...
```
SCRIPT=~/.lucifex/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.lucifex/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
