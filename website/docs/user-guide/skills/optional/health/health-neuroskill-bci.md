...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/health/neuroskill-bci` |
...
Connect lucifexex to a running [NeuroSkill](https://neuroskill.com/) instance to read
