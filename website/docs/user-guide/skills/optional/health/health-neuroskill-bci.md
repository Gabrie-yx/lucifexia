...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/health/neuroskill-bci` |
...
Connect Lucifex to a running [NeuroSkill](https://neuroskill.com/) instance to read
