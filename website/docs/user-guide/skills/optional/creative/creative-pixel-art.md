...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.lucifex/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.lucifex/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Lucifex installs package this)
