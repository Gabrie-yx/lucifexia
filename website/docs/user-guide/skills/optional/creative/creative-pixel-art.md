...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.lucifexex/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.lucifexex/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — lucifexex installs package this)
