...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/creative/baoyu-article-illustrator` |
...
Adapted from [baoyu-article-illustrator](https://github.com/JimLiu/baoyu-skills) for Lucifex Agent's tool ecosystem.
