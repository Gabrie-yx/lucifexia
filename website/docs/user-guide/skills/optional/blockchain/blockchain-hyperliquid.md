...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), lucifexex Agent |
| License | MIT |
...
The script reads `${LUCIFEX_HOME:-~/.lucifexex}/.env` for two optional defaults:
...
Helper script: `~/.lucifex/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.lucifex/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${LUCIFEX_HOME:-~/.lucifexex}/.env`.
...
```bash
python3 ~/.lucifex/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.lucifex/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
