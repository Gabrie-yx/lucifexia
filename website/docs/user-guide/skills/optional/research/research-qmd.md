...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/research/qmd` |
...
Lucifex Agent via the native MCP client. This is the preferred
...
Then configure Lucifex Agent to connect via HTTP:
