...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/research/qmd` |
...
lucifexex Agent via the native MCP client. This is the preferred
...
Then configure lucifexex Agent to connect via HTTP:
