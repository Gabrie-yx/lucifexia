...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Lucifex Agent |
| License | MIT |
...
import upstream classes into Lucifex itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Lucifex core.
