...
| | |
|---|---|
| Source | Optional — install with `lucifex skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | lucifex Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $lucifex_OSINT_CACHE/icij/ (default: ~/.cachlucifexifex-osint/icij/).
...
# Set lucifex_OSINT_UA=your-app/1.0 (your@email) to identify yourself
