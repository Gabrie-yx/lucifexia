...
| | |
|---|---|
| Source | Optional — install with `lucifexex skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | lucifexex Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $lucifexex_OSINT_CACHE/icij/ (default: ~/.cachlucifexifex-osint/icij/).
...
# Set lucifexex_OSINT_UA=your-app/1.0 (your@email) to identify yourself
