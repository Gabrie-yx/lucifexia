...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Lucifex Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Lucifex tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Lucifex core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build a Lucifex Plugin](/guides/build-a-lucifex-plugin)
...
2. **`toolsets.py`** — add tool name to `_LUCIFEX_CORE_TOOLS` (or a specific toolset)
...
- [ ] Tested with `lucifex chat -q "Use the weather tool for London"`
