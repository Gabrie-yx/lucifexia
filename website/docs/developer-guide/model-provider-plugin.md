...
See [Building a Lucifex Plugin](/guides/build-a-lucifex-plugin#distribute-via-pip) for the full entry-points setup.
...
- [Building a Lucifex Plugin](/guides/build-a-lucifex-plugin) — general plugin authoring
