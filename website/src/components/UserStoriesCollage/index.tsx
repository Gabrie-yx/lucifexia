  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Lucifex Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Lucifex &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Lucifex?{' '}
        <a
          href="https://github.com/NousResearch/lucifex-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
