#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the lucifexdocs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use lucifexas a Python Library", None),
        ("guides/use-mcp-with-lucifex, "Use MCP with llucifex None),
        ("guides/use-voice-mode-with-lucifex, "Use Voice Mode with llucifex None),
        ("guides/use-soul-with-lucifex, "Use SOUL.md with llucifex None),
        ("guides/build-a-lucifexplugin", "Build a llucifexlugin", None),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# lucifexAgent — Full Documentation\n",
        (
            "This file is the entire lucifexAgent documentation concatenated for LLM "
