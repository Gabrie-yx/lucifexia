...
lucifex skills install https://sharethis.chat/SKILL.md                     # 直接 URL（单文件 SKILL.md）
...
参见 [Plugins](../user-guide/features/plugins.md) 和 [构建 Lucifex Plugin](../guides/build-a-lucifex-plugin.md)。
