...
def _config_model_target() -> tuple[str, str]:
    ...
    # LUCIFEX_INFERENCE_MODEL, which `hermes --tui -m <model>` sets as a
...
def _apply_model_switch(
    ...
    *,
    ...
    # LUCIFEX_INFERENCE_MODEL / HERMES_TUI_PROVIDER / HERMES_INFERENCE_PROVIDER)
...
def _is_repo_junk(root: str) -> bool:
    ...
    anything under LUCIFEX_HOME (~/.hermes by default) — config/sessions/skills,
