...
_APP_VERSION = _LUCIFEX_VERSION
_BOT_VERSION = _LUCIFEX_VERSION
_YUANBAO_INSTANCE_ID = str(LUCIFEX_INSTANCE_ID)  # single source: yuanbao_proto.LUCIFEX_INSTANCE_ID
