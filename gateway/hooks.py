...
Hooks are discovered from ~/.lucifex/hooks/ directories, each containing:
...
HOOKS_DIR = get_lucifex_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"lucifex_hook_{hook_name}"
