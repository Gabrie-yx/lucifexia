...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$LUCIFEX_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_lucifex_dir("platforms/whatsapp/session", "whatsapp/session")
