...
class LucifexCLI(CLIAgentSetupMixin, CLICommandsMixin, CLIBillingMixin):
    ...
    def __init__(
        ...
        # by `hermes chat --ignore-rules` in lucifex_cli/main.py. When true we
        ...
        # it's shared across all Hermes processes for this LUCIFEX_HOME.
        ...
        self._history_file = _LUCIFEX_HOME / ".hermes_history"
    ...
    def show_banner(self):
        ...
        from lucifex_cli.model_switch import is_nous_hermes_non_agentic
