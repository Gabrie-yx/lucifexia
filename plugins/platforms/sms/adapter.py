...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Lucifex gateway adapter.

    Each inbound phone number gets its own Lucifex session (multi-tenant).
...
# static dict in lucifex_cli/gateway.py, and the _send_sms dispatch in
