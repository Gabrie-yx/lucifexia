...
def resolve_active_host() -> str:
    ...
    Resolution order:
      ...
      2. Active profile name via profiles system -> ``lucifex.<profile>``
      3. Fallback: ``"lucifex"`` (default profile)
    """
...
class HonchoClientConfig:
    ...
    # Max chars of dialectic result to inject into Lucifex system prompt
...
def get_honcho_client(config: HonchoClientConfig | None = None) -> Honcho:
    ...
    def _build() -> "Honcho":
        ...
        # the "go run lucifex honcho setup" hint they used to.
        try:
