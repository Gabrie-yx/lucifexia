...
class HonchoSessionManager:
    ...
    Runs alongside lucifex' existing SQLite state and file-based memory,
    ...
    def get_or_create(self, key: str) -> HonchoSession:
        ...
        assistant_peer_id = self._sanitize_id(
            self._config.ai_peer if self._config else "lucifex-assistant"
        )
    ...
    def dialectic_query(
        ...
        try:
            ...
            # Only automatic injection uses the Lucifex-side character cap.
            if (
                apply_injection_cap
                and result
    ...
    def get_prefetch_context(self, session_key: str, user_message: str | None = None) -> dict[str, str]:
        ...
        # Also fetch AI peer's own representation so Lucifex knows itself.
        try:
