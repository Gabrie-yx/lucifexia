...
# When the user hasn't picked a reasoning effort, Lucifex passes
...
# ON at this effort — matching the "medium (default)" that Lucifex' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Lucifex' effort vocabulary onto Solar's accepted set. xhigh/max/
