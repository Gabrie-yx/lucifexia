# Lucifex Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.lucifex/plugins/lucifex-achievements/state.json` (existing unlock state)
  - `~/.lucifex/plugins/lucifex-achievements/scan_snapshot.json` (new)
  - `~/.lucifex/plugins/lucifex-achievements/scan_checkpoint.json` (new)
