# Lucifex Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.lucifex/plugins/lucifex-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.lucifex/plugins/lucifex-achievements/scan_checkpoint.json`.
