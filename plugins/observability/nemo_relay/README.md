...
```bash
env LUCIFEX_HOME=/tmp/hermes-nemo-relay-test \
  hermes plugins enable observability/nemo_relay
```
...
`LUCIFEX_HOME` is the Hermes profile/config home used by both
...
```bash
export LUCIFEX_HOME=/tmp/hermes-nemo-relay-test
hermes plugins enable observability/nemo_relay
...
export LUCIFEX_HOME=/tmp/hermes-nemo-relay-docs/hermes-home
...
```bash
export LUCIFEX_HOME=/tmp/hermes-middleware-test/hermes-home
mkdir -p "$LUCIFEX_HOME" /tmp/hermes-middleware-test/nemo-relay
