...
- Snapshot persisted at `~/.lucifex/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.lucifex/plugins/hermes-achievements/scan_checkpoint.json`.
