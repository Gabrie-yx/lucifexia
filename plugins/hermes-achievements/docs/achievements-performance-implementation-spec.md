...
Storage path:
- `~/.lucifex/plugins/hermes-achievements/scan_snapshot.json`
...
Checkpoint file (new):
- `~/.lucifex/plugins/hermes-achievements/scan_checkpoint.json`
...
- persisted runtime files:
  - `~/.lucifex/plugins/hermes-achievements/state.json` (existing unlock state)
  - `~/.lucifex/plugins/hermes-achievements/scan_snapshot.json` (new)
  - `~/.lucifex/plugins/hermes-achievements/scan_checkpoint.json` (new)
