(function () {
  ...
  // Bundled into lucifex-agent. Upstream repo remains the staging ground for new
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("HERMES AGENT  ·  lucifex-agent.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function tweetText() {
      ...
      return tmpl + "\n\n@NousResearch · https://lucifex-agent.nousresearch.com";
    }
