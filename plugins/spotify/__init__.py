...
``_check_spotify_available()`` — when the user has not run ``lucifex auth
spotify``, the tools remain registered (so they appear in ``lucifex
...
The Spotify auth flow (``lucifex auth spotify``), CLI plumbing, and docs
