...
(function () {
  ...
  const DOCS_URL = "https://lucifex-agent.nousresearch.com/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://lucifex-agent.nousresearch.com/docs/user-guide/features/kanban-tutorial";
