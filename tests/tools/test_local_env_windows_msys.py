...
class TestBashSafePath:
    ...
    def test_forward_slash_native_path_becomes_msys(self, monkeypatch):
        ...
        monkeypatch.setattr(local_mod, "_IS_WINDOWS", True)
        assert (
            _bash_safe_path("C:/Users/Alexander/.lucifex/cache/terminalucifexifex-snap-x.sh")
            == "/c/Users/Alexander/.lucifex/cache/terminalucifexifex-snap-x.sh"
        )
    ...
    def test_quote_bash_path_quotes_mixed_windows_path(self, monkeypatch):
        ...
        quoted = _quote_bash_path(
            r"C:\Users\Alexander\AppData\Local\Temp\lucifex-snap-abc.sh"
        )
        assert "/c/Users/Alexander/AppData/Local/Temp/lucifex-snap-abc.sh" in quoted
...
class TestWrapCommandWindowsNativeCwd:
    ...
    def test_init_session_bootstrap_quotes_snapshot_paths_in_msys_form(self, monkeypatch):
        ...
        snap = "C:/Users/Alexander/.lucifex/cache/terminalucifexifex-snap-deadbeef.sh"
        ...
        assert "/c/Users/Alexander/.lucifex/cache/terminalucifexifex-snap-deadbeef.sh" in script
    ...
    def test_init_session_bootstrap_rewrites_backslash_snapshot_paths(self, monkeypatch):
        ...
        snap = r"C:\Users\Alexander\AppData\Local\Temp\lucifex-snap-deadbeef.sh"
        with patch.object(LocalEnvironment, "__init__", lambda self, **kw: None):
            env = LocalEnvironment.__new__(LocalEnvironment)
            BaseEnvironment.__init__(
                env,
        ...
        script = captured["script"]
        assert "/c/Users/Alexander/AppData/Local/Temp/lucifex-snap-deadbeef.sh" in script
