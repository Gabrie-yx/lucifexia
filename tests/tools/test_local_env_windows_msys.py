...
class TestBashSafePath:
    ...
    def test_forward_slash_native_path_becomes_msys(self, monkeypatch):
        ...
        monkeypatch.setattr(local_mod, "_IS_WINDOWS", True)
        assert (
            _bash_safe_path("C:/Users/Alexander/.lucifex/cache/terminalucifex-snap-x.sh")
            == "/c/Users/Alexander/.lucifex/cache/terminalucifex-snap-x.sh"
        )
...
class TestWrapCommandWindowsNativeCwd:
    ...
    def test_init_session_bootstrap_quotes_snapshot_paths_in_msys_form(self, monkeypatch):
        ...
        snap = "C:/Users/Alexander/.lucifex/cache/terminalucifex-snap-deadbeef.sh"
        ...
        assert "/c/Users/Alexander/.lucifex/cache/terminalucifex-snap-deadbeef.sh" in script
