"""Tests for _setup_feishu() in lucifex_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("lucifex_cli.config.save_env_value", side_effect=mock_save), \
         patch("lucifex_cli.config.get_env_value", side_effect=mock_get), \
         patch("lucifex_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("lucifex_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("lucifex_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("lucifex_cli.cli_output.print_header"), \
         patch("lucifex_cli.cli_output.print_info"), \
         patch("lucifex_cli.cli_output.print_success"), \
         patch("lucifex_cli.cli_output.print_warning"), \
         patch("lucifex_cli.cli_output.print_error"), \
