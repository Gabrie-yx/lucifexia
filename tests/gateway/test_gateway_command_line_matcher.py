...
ACCEPT = [
    ...
    r"C:\Users\me\hermes\venv\Scripts\pythonw.exe -m lucifex_cli.main gateway run",
    ...
    r'"C:\Program Files\Hermes\lucifex-gateway.exe"',
...
REJECT = [
    ...
    "python -m lucifex_cli.main gateway status",           # other subcommand
    "python -m lucifex_cli.main gateway restart",
    "python -m lucifex_cli.main gateway stop",
    "python -m lucifex_cli.main --profile x dashboard",    # non-gateway subcommand
...
def test_runtime_matcher_accepts_no_supervisor_restart_process():
    assert matches("python -m lucifex_cli.main gateway restart") is False
    assert matches_runtime("python -m lucifex_cli.main gateway restart") is True
    assert matches_runtime("python -m lucifex_cli.main gateway status") is False
