...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("LUCIFEX_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("LUCIFEX_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("LUCIFEX_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
