...
def test_config_max_turns_wins_over_stale_env(LUCIFEX_HOME: Path) -> None:
    ...
    _write_env(LUCIFEX_HOME, {"HERMES_MAX_ITERATIONS": "60"})
...
def test_config_display_busy_input_mode_wins_over_stale_env(LUCIFEX_HOME: Path) -> None:
    ...
    _write_env(LUCIFEX_HOME, {"HERMES_GATEWAY_BUSY_INPUT_MODE": "queue"})
...
def test_config_display_busy_text_mode_wins_over_stale_env(LUCIFEX_HOME: Path) -> None:
    ...
    _write_env(LUCIFEX_HOME, {"HERMES_GATEWAY_BUSY_TEXT_MODE": "interrupt"})
...
def test_env_value_survives_when_config_omits_key(LUCIFEX_HOME: Path) -> None:
    ...
    _write_env(LUCIFEX_HOME, {"HERMES_MAX_ITERATIONS": "123"})
