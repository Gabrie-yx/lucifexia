...
class TestPayloadFilters:
    ...
    async def test_filter_accepts_nested_any_and_in_file(self, tmp_path, monkeypatch):
        """Nested any groups can match dynamic watchlists under LUCIFEX_HOME."""
    ...
    @pytest.mark.asyncio
    async def test_script_tilde_lucifex_path_resolves_to_active_profile_home(self, tmp_path, monkeypatch):
