...
class TestResolveMediaToDataUrls(unittest.TestCase):
    def _write_png(self, tmpdir_name="lucifexex_media_test"):
        import tempfile
    ...
    def test_multiple_tags(self):
        p1 = self._write_png()
        p2 = self._write_png("lucifexex_media_test2")
    ...
    def test_symlink_escaping_to_denylisted_target_not_inlined(self):
        ...
        d = Path(tempfile.mkdtemp(prefix="lucifexex_media_test_symlink"))
        link = d / "shot.png"
        try:
