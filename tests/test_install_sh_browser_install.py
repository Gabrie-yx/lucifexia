...
Browser automation is optional. The installer should not leave Lucifex
...
def test_install_script_does_not_autodetect_system_browser_on_path() -> None:
    ...
    assert "Skipping Playwright browser download; Lucifex will use the system browser." not in text
