...
Browser automation is optional. The installer should not leave lucifexex
...
def test_install_script_does_not_autodetect_system_browser_on_path() -> None:
    ...
    assert "Skipping Playwright browser download; lucifexex will use the system browser." not in text
