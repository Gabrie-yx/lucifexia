...
AlexKucera reported on Discord (2026-04-16) that after ``lucifex update`` pulled
...
Opt-in — not part of default CI:
    LUCIFEX_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v
...
def _load_user_env() -> None:
    env_file = Path.home() / ".lucifex" / ".env"
