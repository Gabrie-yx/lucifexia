...
old_session_id=<old>). This lets plugin engines (e.g. lucifexex-lcm) preserve
DAG lineage across the split instead of treating it as a fresh /new.

See lucifexex-lcm#68: aftelucifexifex compresses and mints a new physical session,
