...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from lucifex_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in LUCIFEX_OVERLAYS
        overlay = LUCIFEX_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify lucifex doctor recognizes Xiaomi env vars."""
