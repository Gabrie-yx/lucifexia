"""Tests for the specifier module + `lucifex kanban specify` CLI surface.
...
from lucifex_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `lucifex kanban …` argparse surface directly."""
