...
Simulates a slow lucifex_cli.gateway import (15-30 s on a fresh Windows install
...
1. _lifespan fire-and-forget: patched _warm_gateway_module sleeps N seconds in
   ...
   blocked, LUCIFEX_DASHBOARD_READY would fire immediately).
...
import lucifex_cli.web_server as web_server_mod
...
def test_lifespan_warmup_is_nonblocking():
    ...
    LUCIFEX_DASHBOARD_READY would have fired without delay.
    """
