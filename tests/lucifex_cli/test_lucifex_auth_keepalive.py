from lucifex_cli import lucifex_auth_keepalive as keepalive
...
def test_keepalive_refreshes_stale_pool_entry(monkeypatch):
    ...
    assert keepalive.refresh_lucifex_auth_keepalive_once() is True
...
def test_keepalive_falls_back_to_singleton_state(monkeypatch):
    ...
    assert keepalive.refresh_lucifex_auth_keepalive_once(timeout_seconds=15.0) is True
