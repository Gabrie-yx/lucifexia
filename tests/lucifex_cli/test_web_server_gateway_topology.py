...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_lucifex_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # Lucifex Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside lucifex_home / gateway_pid.
            assert "gateways" not in data
            assert "lucifex_home" not in data
