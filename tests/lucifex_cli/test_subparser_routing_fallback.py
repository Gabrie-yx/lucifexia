...
The main() function in lucifex_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `lucifex -c model`
...
def _build_parser():
    """Build a minimal replica of the lucifex top-level parser."""
