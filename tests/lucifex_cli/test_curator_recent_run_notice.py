...
The notice prints the most recent curator run summary on `lucifex update`,
...
session start) so users normally never see the rename map. `lucifex update`
