...
from lucifex_cli.nous_account import NousPortalAccountInfo, NousToolAccessInfo
from lucifex_cli import nous_subscription as ns
...
# ---------------------------------------------------------------------------
# ensure_nous_portal_access — inline login gate for `lucifex tools`
# ---------------------------------------------------------------------------
