"""Tests for the lucifex_cli.lucifex_billing HTTP client's response handling.
...
from lucifex_cli import lucifex_billing as nb
...
def test_urlerror_dns_maps_to_network_error(monkeypatch):
    ...
    assert "Could not reach Lucifex portal" in str(ei.value)
