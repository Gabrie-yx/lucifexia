...
def test_dry_run_prints_plan_without_mutating(monkeypatch, tmp_path, capsys):
    ...
    monkeypatch.setattr(uninstall, "_is_default_lucifex_home", lambda home: False)
    ...
    assert str(lucifex_home) in output
