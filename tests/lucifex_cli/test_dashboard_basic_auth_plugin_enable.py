...
from lucifex_cli.dashboard_auth import clear_providers, list_providers
from lucifex_cli.plugins import PluginManager, discover_plugins
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, lucifex_home, monkeypatch):
    ...
    def test_unblock_then_rediscover_registers_provider(
        ...
        _write_config(lucifex_home, cfg)
