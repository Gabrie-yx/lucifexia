"""Tests for the interactive session browser (`lucifex sessions browse`).
...
from lucifex_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """lucifex sessions browse should be parseable."""
