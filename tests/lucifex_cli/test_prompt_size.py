"""Tests for the ``lucifex prompt-size`` diagnostic (issue #34667)."""
...
from lucifex_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(lucifex_home, memory_text="", user_text=""):
    mem_dir = lucifex_home / "memories"
...
def _seed_skill(lucifex_home, name, description):
    skill_dir = lucifex_home / "skills" / "demo" / name
