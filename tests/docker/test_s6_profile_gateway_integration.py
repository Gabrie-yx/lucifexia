...
The unit tests in tests/lucifex_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned lucifex-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/lucifex")
from lucifex_cli.service_manager import S6ServiceManager
