...
class TestGetDefaultModelForProvider:
    """Unit tests for lucifex_cli.models.get_default_model_for_provider."""
    ...
    def test_nous_silent_default_is_not_the_expensive_flagship(self):
        """Lucifex portal is a metered aggregator whose curated list is ordered
    ...
    def test_catalog_label_overrides_constant(self):
        ...
        with patch(
            "lucifex_cli.model_catalog.get_default_model_from_cache",
