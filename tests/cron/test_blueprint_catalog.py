...
the shared /blueprint command handler (lucifex_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated LUCIFEX_HOME for anything that touches the
cron job store.
"""
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from lucifex_cli.blueprint_cmd import handle_blueprint_command, match_blueprint
