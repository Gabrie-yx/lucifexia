"""Session <-> workspace grouping key (lucifex_state.workspace_key).

The key is what `lucifex sessions list --workspace` groups/filters on. It is a
...
from lucifex_state import workspace_key
