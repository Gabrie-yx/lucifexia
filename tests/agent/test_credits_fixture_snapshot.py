...
``build_lucifex_credits_snapshot`` maps a live portal account; ``_snapshot_from_credits_state``
maps a header-shaped CreditsState (e.g. a LUCIFEX_DEV_CREDITS_FIXTURE) into the SAME
