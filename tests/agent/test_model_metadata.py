...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / Lucifex portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# Lucifex portal context-window resolution (provider="nous")
# =========================================================================

class TestLucifexportalContextResolution:
    """Lucifex portal /v1/models is authoritative for what Nous infra enforces
    ...
    def test_portal_value_wins_over_openrouter_catalog(
        ...
        the Lucifex portal correctly enforces 262144.  Portal must win."""
        import agent.model_metadata as mm
        cache_file = tmp_path / "context_length_cache.yaml"
        monkeypatch.setattr(mm, "_get_context_cache_path", lambda: cache_file)
    ...
    def test_bypass_keyed_on_url_not_provider_string(
        ...
        when the user is really on Lucifex portal (e.g. cred-pool fallback).
