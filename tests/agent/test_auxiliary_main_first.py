...
Prior to this change, aggregator users (OpenRouter / Lucifex portal) had aux
...
class TestResolveAutoMainFirst:
    ...
    def test_nous_main_uses_main_model_for_aux(self, monkeypatch):
        """Lucifex portal main user → aux uses their picked Nous model, not free-tier MiMo."""
...
class TestResolveVisionMainFirst:
    ...
    def test_copilot_vision_sets_vision_header(self, monkeypatch):
        ...
        with patch(
            ...
            "lucifex_cli.copilot_auth.copilot_request_headers",
