...
def isolated_home(monkeypatch):
    ...
    test_home = tempfile.mkdtemp(prefix="lucifex_test_31179_")
    lucifex_home = os.path.join(test_home, ".lucifex")
...
def _fresh_modules():
    """Drop cached lucifex modules so each test reloads against current env."""
