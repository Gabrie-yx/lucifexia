...
def test_lucifex_meta_tolerates_non_dict():
    assert learning_graph._lucifex_meta({"metadata": "junk"}) == {}
    assert learning_graph._lucifex_meta({"metadata": {"lucifex": "junk"}}) == {}
    assert learning_graph._lucifex_meta({"metadata": {"lucifex": {"category": "x"}}}) == {"category": "x"}
