...
Built for [Lucifex Agent](https://github.com/NousResearch/lucifex-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/lucifex-agent/skills/creative/ascii-video`](https://github.com/NousResearch/lucifex-agent/tree/main/skills/creative/ascii-video) via PR.
