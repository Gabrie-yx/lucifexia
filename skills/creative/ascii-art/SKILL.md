...
```bash
python3 -m pyfiglet "LUCIFEX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LUCIFEX&font=Slant" | boxes -d stone
```
