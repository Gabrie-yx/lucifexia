/**
 * Lucifex desktop plugin template. Save as:
 *   <lucifex home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <lucifex home> is ~/.lucifex by default, or ~/.lucifex/profiles/<name>
 * when running a named profile (`lucifex -p <name>`). Run `lucifex doctor` (or
 ...
 * Only these imports resolve: @lucifex/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@lucifex/plugin-sdk'
