# Streaming LLM Response Support for Lucifex Agent
...
```
LUCIFEX_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LUCIFEX_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `lucifex_cli/config.py` | 1 | +streaming config defaults |
...
LUCIFEX_STREAMING_ENABLED=true
```
