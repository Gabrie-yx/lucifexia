...
export function buildReviewFlatList(files: LucifexReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: LucifexReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
