...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/lucifex'
...
const VERSION = 3
const PREFIX = 'HML' // "Lucifex Memory Loadout" — namespaces our codes like WoW's leading bytes.
