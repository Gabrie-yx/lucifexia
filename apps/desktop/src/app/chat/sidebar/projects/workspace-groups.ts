...
import type { ProjectInfo, SessionInfo } from '@/lucifex'
 ...
 * repo shows its branches/worktrees even when they have no Lucifex sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: LucifexGitWorktree[]
): SidebarSessionGroup[] {
