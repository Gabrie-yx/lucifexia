...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/lucifex'
...
// / Program Files), which buried any files Lucifex wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.lucifexDesktop` is
    ...
    const settings = window.lucifexDesktop?.settings
