...
vi.mock('@/lucifex', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@/lucifex')>()
  return {
    ...actual,
...
beforeEach(() => {
  ...
  getMoaModels.mockResolvedValue({ presets: {}, default_preset: '', enabled: false, layers: [] })
