...
const STORAGE_KEY = 'lucifex.desktop.layoutTree.v2'

writeKey('lucifex.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('lucifex.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('lucifex.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'lucifex.desktop.dismissedPanes.v1'
...
const USER_PLACED_KEY = 'lucifex.desktop.userPlacedPanes.v1'
...
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__LUCIFEX_LAYOUT_TREE__ = {
    close: closeTreePane,
