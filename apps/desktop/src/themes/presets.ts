...
/**
 * Lucifex — identidade visual principal. Obsidiana com acentos cyber-vermelhos brilhantes.
 */
export const nousTheme: DesktopTheme = {
  name: 'nous',
  label: 'Lucifex',
  description: 'Obsidiana com acentos cyber-vermelhos brilhantes',
  colors: {
    background: '#0a0606',
    foreground: '#fafafa',
    card: '#140c0c',
    ...
    sidebarBackground: '#070404',
    sidebarBorder: '#1c1010',
    userBubble: '#1b0f0f',
    userBubbleBorder: '#ff3333'
  },
  darkColors: {
    background: '#0a0606',
    foreground: '#fafafa',
  ...
  typography: {
    fontSans: `"Outfit", ${SYSTEM_SANS}`,
    fontMono: `"JetBrains Mono", ${SYSTEM_MONO}`,
    fontUrl: 'https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;700&display=swap'
  }
}
