 ...
 * `<lucifex home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'lucifex.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'lucifex.desktop.disabledPlugins.v1'
