...
import type { LucifexGitWorktree, LucifexRepoStatus } from '@/global'
...
export const $repoStatus = atom<LucifexRepoStatus | null>(null)
...
export const $repoWorktrees = atom<LucifexGitWorktree[]>([])
...
interface RepoStatusRefreshRequest {
  probe: (cwd: string) => Promise<LucifexRepoStatus | null>
  seq: number
  target: string
}
