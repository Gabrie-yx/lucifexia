 ...
 * plugins resolve `@lucifex/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __LUCIFEX_PLUGIN_SDK__: sdk,
  __LUCIFEX_REACT__: React,
  __LUCIFEX_REACT_JSX__: jsxRuntime,
  __LUCIFEX_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@lucifex/plugin-sdk': shimUrl('__LUCIFEX_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__LUCIFEX_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__LUCIFEX_REACT_JSX__'),
    react: shimUrl('__LUCIFEX_REACT__')
  }
