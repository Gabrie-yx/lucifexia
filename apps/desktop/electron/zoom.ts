...
export const ZOOM_STORAGE_KEY = 'lucifex:desktop:zoomLevel'
 ...
 * but forgot to emit 'lucifex:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('lucifex:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })
