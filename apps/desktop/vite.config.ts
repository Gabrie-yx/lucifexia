...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\lucifex\lucifex-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@lucifex/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@lucifex/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@lucifex/shared': path.resolve(__dirname, '../shared/src'),
