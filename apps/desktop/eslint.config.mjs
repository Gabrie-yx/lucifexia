...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @lucifex/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@lucifex/shared'],
              message: 'Plugins import only @lucifex/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
