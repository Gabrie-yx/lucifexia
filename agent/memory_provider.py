...
Optional hooks (override to opt in):
  ...
  backup_paths() -> list[str]            — extra on-disk paths to include in `lucifex backup`
"""
...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - lucifex_home (str): The active LUCIFEX_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.lucifex``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "lucifex").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'lucifex memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], lucifex_home: str) -> None:
        ...
        Called by 'lucifex memory setup' after collecting user inputs.
    ...
    def backup_paths(self) -> List[str]:
        ...
        ``lucifex backup`` only walks LUCIFEX_HOME, so any provider state kept
        ...
        of the archive, and ``lucifex import`` restores them to their original
