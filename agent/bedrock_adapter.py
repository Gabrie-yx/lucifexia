"""AWS Bedrock Converse API adapter for Lucifex Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Lucifex with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Lucifex is installed editable into system Python, the system boto3
