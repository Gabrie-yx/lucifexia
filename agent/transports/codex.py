...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Lucifex's web-provider config and
        ...
        # native search engine for xAI sessions instead of Lucifex's
        # configured web provider (Tavily/etc.), and those results bypass
        # Lucifex's tool-trace / citation plumbing (they arrive baked into the
