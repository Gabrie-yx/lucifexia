...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``lucifex logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Lucifex only initiates compaction in "lucifex" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Lucifex preflight compression for codex app-server "
                "(mode=%s); Lucifex will not start thread compaction here.",
