...
DEFAULT_AGENT_IDENTITY = (
    "You are Lucifex Agent, an intelligent AI assistant created by Nous Research. "
...
PLATFORM_HINTS = {
    ...
    "desktop": (
        "You are chatting inside the Lucifex desktop app — a graphical chat "
...
def _current_session_platform_hint() -> str:
    ...
    platform = os.environ.get("LUCIFEX_PLATFORM") or os.environ.get("LUCIFEX_SESSION_PLATFORM")
    if platform:
        return platform
...
def build_context_files_prompt(
    ...
    # Never let a FALLBACK-picked directory inside the Lucifex install/source
    ...
    # explicitly configured cwd is honored verbatim — the Lucifex tree is a
    ...
    # their launch dir IS the user's shell cwd (developing Lucifex in-tree).
    ...
    if (
        ...
        logger.warning(
            ...
            "fell back to the Lucifex install tree (%s) — set terminal.cwd to "
