"""Vertex AI (Google Cloud) adapter for Lucifex Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Lucifex to use Gemini models via Google Cloud with
...
# who installed plain `lucifex-agent` and only later selected a Gemini model.
try:
