...
Data file: $LUCIFEX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_LUCIFEX_HOME = Path(os.environ.get("LUCIFEX_HOME", Path.home() / ".lucifex"))
DATA_DIR = _LUCIFEX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
