---
name: honcho
description: Configure and use Honcho memory with Lucifex -- cross-session user modeling, multi-profile peer isolation, observation config, dialectic reasoning, session summaries, and context budget enforcement. Use when setting up Honcho, troubleshooting memory, managing profiles with Honcho peers, or tuning observation, recall, and dialectic settings.
version: 2.0.0
...
See: https://docs.honcho.dev/v3/guides/integrations/lucifex#running-honcho-locally-with-lucifex
...
| `lucifex honcho sync` | Create host blocks for all Lucifex profiles that don't have one yet |
| `lucifex honcho migrate` | Step-by-step migration guide from OpenClaw native memory to Lucifex + Honcho |
