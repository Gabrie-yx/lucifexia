#!/usr/bin/env python3
"""Build the Lucifex Skills Index — a centralized JSON catalog of all skills.
...
`lucifex skills search/install` can use it without hitting the GitHub API.
...
# Ensure LUCIFEX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Lucifex Skills Index...", flush=True)
