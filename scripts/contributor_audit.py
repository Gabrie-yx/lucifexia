...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Lucifex\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "lucifex@nousresearch.com",
    "lucifex-audit@example.com",
    "lucifex@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/lucifex-agent",
                "--state", "merged",
