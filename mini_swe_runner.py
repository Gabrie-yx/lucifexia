#!/usr/bin/env python3
"""
SWE Runner with Lucifex Trajectory Format

A runner that uses Lucifex-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Lucifex-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Lucifex-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Lucifex format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Lucifex-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Lucifex-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Lucifex Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Lucifex-Agent's built-in execution environments
    and outputs trajectories in Lucifex-Agent format.
    """
    ...
    def _convert_to_lucifex_format(
        self,
        ...
        """
        Convert internal message format to Lucifex trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Lucifex trajectory format
        trajectory = self._convert_to_lucifex_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Lucifex trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Lucifex Trajectory Format")
    print("=" * 60)
